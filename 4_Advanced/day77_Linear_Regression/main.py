...
print(f'Number of films that grossed $0 wordlwide {len(zero_worldwide)}')
...
print(f"{round((money_losing.shape[0]/data_clean.shape[0]) * 100, 2)}%")
...
print(len(old_films))
old_films.describe()
old_films[old_films.USD_Production_Budget == 42000000.00]
